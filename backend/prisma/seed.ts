...
async function main() {
  ...
  await prisma.personaSaludOdontologica.create({
    data: {
      id_persona: pLead1.id_persona,
      estado_general_bucal: 'Regular — presenta algunas piezas con desgaste',
      nivel_higiene_bucal: 'Moderado',
      frecuencia_cepillado: '2 veces al día',
      usa_enjuague_bucal: 'No',
      usa_hilo_dental: 'Ocasionalmente',
      ultima_visita_odontologo: 'Hace 2 años',
      tiene_caries: 'Sí',
      tiene_enfermedad_gingival: 'Sí (leve)',
      tiene_sensibilidad: 'No',
      usa_protesis: 'No',
      usa_ortodoncia: 'No',
      tiene_bruxismo: 'Sí (nocturno)',
      condiciones_relevantes: 'Rechinido nocturno, usa férula en ocasiones',
      tratamientos_previos: 'Extracción de muelas del juicio (2019), resinas anteriores',
      alergias_materiales: 'Ninguna conocida',
      medicamentos_actuales: 'Ninguno',
      motivo_consulta_principal: 'Evaluación de ortodoncia y corrección de apiñamiento',
      objetivo_estetico: 'Mejorar alineación dental y estética general de sonrisa',
    }
  });
  ...
  await prisma.personaSaludOdontologica.create({
    data: {
      id_persona: pLead2.id_persona,
      estado_general_bucal: 'Bueno — dentición completa sin piezas perdidas',
      nivel_higiene_bucal: 'Alto',
      frecuencia_cepillado: '3 veces al día',
      usa_enjuague_bucal: 'Sí',
      usa_hilo_dental: 'Diariamente',
      ultima_visita_odontologo: 'Hace 8 meses',
      tiene_caries: 'No',
      tiene_enfermedad_gingival: 'No',
      tiene_sensibilidad: 'Sí (al frío)',
      usa_protesis: 'No',
      usa_ortodoncia: 'No',
      tiene_bruxismo: 'No',
      condiciones_relevantes: 'Sensibilidad leve en piezas superiores',
      tratamientos_previos: 'Profilaxis anual',
      alergias_materiales: 'Posible alergia al níquel (referida)',
      medicamentos_actuales: 'Anticonceptivos orales',
      motivo_consulta_principal: 'Blanqueamiento dental antes de graduación universitaria',
      objetivo_estetico: 'Dientes blancos y uniformes para evento fotográfico',
    }
  });

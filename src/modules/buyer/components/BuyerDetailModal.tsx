              ...
              {buyer && (
                <div className="flex items-center gap-2">
                  <StatusBadge 
                    status={buyer.state} 
                    variant={
                      buyer.state === BuyerState.CONVERTED ? 'success' :
                      buyer.state === BuyerState.DISCARDED ? 'error' :
                      buyer.state === BuyerState.DUPLICATED ? 'purple' :
                      buyer.state === BuyerState.NEW ? 'warning' : 'neutral'
                    } 
                  />
                  {!isConverted ? (
                    <Button 
